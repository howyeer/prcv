...
def inference_detector(model,
    ...
    # image = cv2.rectangle(image,  (0, 255, 0), -1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', default='img/bus.jpg', help='image path, include image file or dir.')
    parser.add_argument(
        '--text', default='bus,glasses,person,shose,face',
        help=
