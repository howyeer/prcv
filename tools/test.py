...
import sys
sys.path.append('/home/hhy_2023/aaaacode/YOLO-World')
...
def parse_args():
    ...
    parser.add_argument('--config',default='configs/finetune_coco/yolo_world_v2_l_vlpan_bn_sgd__prcv.py', help='test config file path')
    parser.add_argument('--checkpoint', default='work_dirs/yolo_world_v2_l_vlpan_bn_sgd__prcv/epoch_40.pth',help='checkpoint file')
    parser.add_argument(
        '--work-dir',
