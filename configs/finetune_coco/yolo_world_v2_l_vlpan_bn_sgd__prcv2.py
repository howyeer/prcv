...
load_from = 'pretrained_weights/yolo_world_v2_l_vlpan_bn_sgd_1e-3_40e_8gpus_finetune_coco_ep80-e1288152.pth'
...
coco_train_dataset = dict(_delete_=True,
                          ...
                          dataset=dict(
                              type='YOLOv5PRCVDataset_V1',
                              data_root='data/prcv',
                              ann_file='annotations/train.json',
                              data_prefix=dict(img='train/'),
                              filter_cfg=dict(filter_empty_gt=False,
                                              min_size=32)),
                          class_text_path='data/prcv/prcv_class.json',
...
coco_val_dataset = dict(
    _delete_=True,
    type='MultiModalDataset',
    dataset=dict(type='YOLOv5PRCVDataset_V1',
                 data_root='data/prcv',
...
val_evaluator = dict(_delete_=True,
                     ...
                     ann_file='data/prcv/annotations/val.json',
                     metric='bbox')
